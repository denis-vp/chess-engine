...
namespace chess_engine.Engine
{
    public static class PrecomputedMoveData
    {
        ...
        // For example, if availableSquares[0][1] == 7...
        ...
        // For example, knightMoves[0] is equal to {10, 17}, meaning a knight on a1 can jump to c2 and b3
            ...
            for (int squareIndex = 0; squareIndex < 64; squareIndex++)
            {
                ...
                foreach (int knightJumpDelta in allKnightJumps)
                {
                    ...
                    if (knightJumpSquare >= 0 && knightJumpSquare < 64)
                    {
                        ...
                        int maxCoordMoveDst = Max(Abs(x - knightSquareX), val2: System.Math.Abs(y - knightSquareY));
